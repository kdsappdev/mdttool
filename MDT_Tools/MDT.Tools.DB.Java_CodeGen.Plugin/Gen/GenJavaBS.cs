...
namespace MDT.Tools.DB.Java_CodeGen.Plugin.Gen
{
    ...
    internal class GenJavaBS
    {
        ...
        public string GenCodeInterface(DataRow drTable, DataRow[] drTableColumns)
        {
            ...
            className = "I" + (cmc.CodeRule == CodeGenRuleHelper.Ibatis ? ibatisConfigHelper.GetClassName(className) : CodeGenHelper.StrFirstToUpperRemoveUnderline(className)) + CodeGenRuleHelper.IBSServer;
            ...
            #region 引入包路径
            sb.AppendFormat("package {0};", cmc.BSPackage).AppendFormat("\r\n");
            sb.AppendFormat("\r\n");
            ...
            sb.AppendFormat(" *").Append(string.IsNullOrEmpty(tablecomments) ? className : EncodingHelper.ConvertEncoder(OriginalEncoding,
                                                                                              TargetEncoding,
                                                                                              tablecomments) + CodeGenRuleHelper.IBSSummary).
                AppendFormat("\r\n");
            sb.AppendFormat(" *").AppendFormat("\r\n");
            ...
            sb.AppendFormat(" */").AppendFormat("\r\n");
            sb.AppendFormat("").AppendFormat("public interface {0}", className).Append(" {").AppendFormat("\r\n");
            ...
            sb.AppendFormat("\t").AppendFormat(" *").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat(" * @param location实体").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat(" * @return {0}集合", modelClass).AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat(" */").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat("public List<{0}> select(String location) throws CodeException;", modelClass).AppendFormat("\r\n");
            ...
            sb.AppendFormat("\t").AppendFormat(" *").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat(" * @param shortName短名称").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat(" * @param location实体").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat(" * @return {0}对象", modelClass).AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat(" */").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat("public {0} selectByShortName(String shortName, String location) throws CodeException;", modelClass).AppendFormat("\r\n");
            ...
            sb.AppendFormat("\t").AppendFormat(" *").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat(" * @param {0}{1}", CodeGenHelper.StrFirstToLower(modelClass), string.IsNullOrEmpty(tablecomments) ? className : EncodingHelper.ConvertEncoder(OriginalEncoding,
                                                                                              TargetEncoding,
                                                                                              tablecomments)).AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat(" * @return {0}对象", modelClass).AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat(" */").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat("public {0} insert({0} {1}) throws CodeException;", modelClass, CodeGenHelper.StrFirstToLower(modelClass)).AppendFormat("\r\n");
            ...
            sb.AppendFormat("\t").AppendFormat(" * @return {0}对象", modelClass).AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat(" */").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat("public {0} delete({0} {1}) throws CodeException;", modelClass, CodeGenHelper.StrFirstToLower(modelClass)).AppendFormat("\r\n");
            ...
            sb.AppendFormat("\t").AppendFormat(" * @return {0}对象", modelClass).AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat(" */").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat("public {0} update({0} {1}) throws CodeException;", modelClass, CodeGenHelper.StrFirstToLower(modelClass)).AppendFormat("\r\n");
        ...
        public string GenCode(DataRow drTable, DataRow[] drTableColumns)
        {
            var sb = new StringBuilder();
            string className = drTable["name"] as string;
            className = (cmc.CodeRule == CodeGenRuleHelper.Ibatis ? ibatisConfigHelper.GetClassName(className) : CodeGenHelper.StrFirstToUpperRemoveUnderline(className)) + CodeGenRuleHelper.IBSServer;

            string modelClass = (cmc.CodeRule == CodeGenRuleHelper.Ibatis ? ibatisConfigHelper.GetClassName(drTable["name"] as string) : CodeGenHelper.StrFirstToUpperRemoveUnderline(className));

            string dao = modelClass + CodeGenRuleHelper.DAO;
            string example = modelClass + CodeGenRuleHelper.Example;

            #region 引入包路径
            sb.AppendFormat("package {0}{1};", cmc.BSPackage,".impl").AppendFormat("\r\n");
            sb.AppendFormat("\r\n");
            sb.AppendFormat("import java.util.List;").AppendFormat("\r\n");
            sb.AppendFormat("import org.apache.log4j.Logger;").AppendFormat("\r\n");
            sb.AppendFormat("\r\n");
            sb.AppendFormat("import ats.common.model.po.{0};", modelClass).AppendFormat("\r\n");
            sb.AppendFormat("import ats.common.model.po.{0};", example).AppendFormat("\r\n");
            sb.AppendFormat("import ats.common.model.dao.{0};", dao).AppendFormat("\r\n");
            sb.AppendFormat("import ats.pingo.common.datacheck.bs.IDataCheckServer;").AppendFormat("\r\n");
            sb.AppendFormat("import ats.yukon.datamanager.bs.I{0};",className).AppendFormat("\r\n");
            ...
            sb.AppendFormat(" *").AppendFormat("{0:0000}.{1:00}.{2:00}: 创建. {3} <br/>", DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, PluginName).AppendFormat("\r\n");
            sb.AppendFormat(" */").AppendFormat("\r\n");
            sb.AppendFormat("").AppendFormat("public class {0} implements I{0}", className).Append(" {").AppendFormat("\r\n");

            #region 实现

            #region 字段
            
            string daoF = CodeGenHelper.StrFirstToLower(dao);
            sb.AppendFormat("\t").AppendFormat("private Logger logger = Logger.getLogger(this.getClass().getName());").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat("private IDataCheckServer dataCheckServer;").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat("private {0} {1};", dao, daoF).AppendFormat("\r\n");
            sb.AppendFormat("\r\n");

            sb.AppendFormat("\t").AppendFormat("public void setDataCheckServer(IDataCheckServer dataCheckServer)").Append(" {").AppendFormat("\r\n");
            sb.AppendFormat("\t\t").AppendFormat("this.dataCheckServer =dataCheckServer;").AppendFormat("\r\n");
            sb.AppendFormat("\t").Append("}").AppendFormat("\r\n");

            sb.AppendFormat("\t").AppendFormat("public void set{0}({0} {1})", dao, daoF).Append(" {").AppendFormat("\r\n");
            sb.AppendFormat("\t\t").AppendFormat("this.{0} = {0};", daoF).AppendFormat("\r\n");
            sb.AppendFormat("\t").Append("}").AppendFormat("\r\n");
            sb.AppendFormat("\r\n");
            #endregion
            ...
            sb.AppendFormat("\t").AppendFormat("public List<{0}> select(String location) throws CodeException", modelClass).Append(" {").AppendFormat("\r\n");
            ...
            sb.AppendFormat("\t").AppendFormat(" */").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat("@Override").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat("public {0} selectByShortName(String shortName, String location) throws CodeException", modelClass).Append(" {").AppendFormat("\r\n");
            ...
            sb.AppendFormat("\t").AppendFormat(" */").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat("@Override").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat("public {0} insert({0} {1}) throws CodeException", modelClass, CodeGenHelper.StrFirstToLower(modelClass)).Append(" {").AppendFormat("\r\n");
            ...
            sb.AppendFormat("\t").AppendFormat(" */").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat("@Override").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat("public {0} delete({0} {1}) throws CodeException", modelClass, CodeGenHelper.StrFirstToLower(modelClass)).Append(" {").AppendFormat("\r\n");
            ...
            sb.AppendFormat("\t").AppendFormat(" */").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat("@Override").AppendFormat("\r\n");
            sb.AppendFormat("\t").AppendFormat("public {0} update({0} {1}) throws CodeException ", modelClass, CodeGenHelper.StrFirstToLower(modelClass)).Append(" {").AppendFormat("\r\n");
