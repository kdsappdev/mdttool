...
namespace NVelocity.Runtime {
    ...
    /// </author>
    /// <version> $Id: RuntimeInstance.cs,v 1.9 2003/01/01 12:13:25 corts Exp $
    /// 
    /// </version>
	...
	*/
	...
	private void  setDefaultProperties() {
		...
		Console.Out.WriteLine("Cannot get NVelocity Runtime default properties!\n" + ex.Message);
	    }
	...
	private void  loadDirective(System.String directiveClass, System.String caption) {
	    try {
	    	//TODO:  need to be able to escape commas, becuase they are needed for full Type identification
	    	// Dvsl is using a semi-colon right now instead of a comma - this should be changed.
		Type directiveType = System.Type.GetType(directiveClass.Replace(";", ","));
