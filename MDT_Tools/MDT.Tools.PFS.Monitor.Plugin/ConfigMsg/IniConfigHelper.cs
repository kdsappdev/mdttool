...
namespace MDT.Tools.PFS.Monitor.Plugin.ConfigMsg
{
    /// <summary>
    /// 获取 系统配置文件 ini
    /// </summary>
    public class IniConfigHelper
    {
        ...
        public static PFS_ConfigInfo ReadConfigInfo()
        {
            ...
            GetPrivateProfileString("ConfigNum", "AlertState", "", sb, sb.Capacity, Consts.ConfigPath);
            int Num = 0;
            ...
            GetPrivateProfileString("ConfigNum", "PFSConfigInfoNum", "", sb, sb.Capacity, Consts.ConfigPath);
            int pfsNum = 0;
            ...
            for (int i = 1; i <= pfsNum; i++)
            {
                ...
                //name
                GetPrivateProfileString("Config", "PFSMonitorName" + i, "", sb, sb.Capacity, Consts.ConfigPath);
