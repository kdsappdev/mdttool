...
namespace MDT.ThirdParty.Controls.Util
{

    public class XmlFolding
    {
        private TextEditorControl textEditorControl;
        public TextEditorControl ActiveEditor
        {
            get
            {
        ...
        /// </summary>
        void UpdateFolding(string xml)
        {
            ActiveEditor.Document.FoldingManager.UpdateFoldings(String.Empty, xml);
