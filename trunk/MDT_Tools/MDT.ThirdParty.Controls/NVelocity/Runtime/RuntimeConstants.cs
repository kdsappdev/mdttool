...
namespace NVelocity.Runtime
{
    ...
    public struct RuntimeConstants
    {
        ...
        public const string DEFAULT_RUNTIME_PROPERTIES = "MDT.ThirdParty.Controls.NVelocity.Runtime.Defaults.nvelocity.properties";
        /// <summary>Default Runtime properties. </summary>
        public const string DEFAULT_RUNTIME_DIRECTIVES = "MDT.ThirdParty.Controls.NVelocity.Runtime.Defaults.directive.properties";
