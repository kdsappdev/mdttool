...
namespace NVelocity.Runtime.Parser {
	...
	public void  Statement() {
		...
		default: 
			...
			switch ((jj_ntk_Renamed_Field == - 1)?jj_ntk():jj_ntk_Renamed_Field) {
			    ...
			    case ParserConstants.LPAREN: case ParserConstants.RPAREN: case ParserConstants.ESCAPE: case ParserConstants.TEXT: case ParserConstants.STRING_LITERAL: case ParserConstants.NUMBER_LITERAL: case ParserConstants.DOT: case ParserConstants.LCURLY: case ParserConstants.RCURLY: 
				Text();
				break;
	...
	public void  Escape() {
		...
		/*
				...
				*/
		switch (t.next.kind) {
		    case ParserConstants.IF_DIRECTIVE: case ParserConstants.ELSE_DIRECTIVE: case ParserConstants.ELSEIF_DIRECTIVE: case ParserConstants.END: case ParserConstants.STOP_DIRECTIVE: 
			control = true;
			break;
