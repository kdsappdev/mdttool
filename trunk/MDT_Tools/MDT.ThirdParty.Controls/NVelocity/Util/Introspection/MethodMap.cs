...
namespace NVelocity.Util.Introspection {
	...
	/// 
	/// </returns>
	public virtual IList get(System.String key) {
	...
	/// </summary>
	private Twonk calcDistance(System.Object[] set, System.Type[] base_Renamed) {
		...
		*/
		...
		System.Type setclass = set[i].GetType();
				
		if (!base_Renamed[i].IsAssignableFrom(set[i].GetType()))
		    return null;
